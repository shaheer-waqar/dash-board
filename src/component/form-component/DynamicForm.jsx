...
function DynamicForm({formField,formData,setFormData,handelSumbit,setOpenForm}) {
  ...
  return (
    <form className="w-[100%] m-auto flex flex-col gap-4 py-4"onSubmit={handelSumbit}>
        {formField.map((field,index)=>{
          ...
          <div className="flex w-full justify-center gap-2">
            ...
            className="bg-white border-[1px] hover:bg-blue-100 hover:text-blue-400 px-2 py-2 rounded-[5px]">Cancel</button>
            <button type="submit" className="bg-blue-600 text-white hover:bg-blue-500 px-2 py-2 rounded-[5px] ">Confirm</button>
          </div>
    </form>
  )
}
